/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env production` (hash: c121343cb595589581e8cce9e9c78a52)
// Runtime types generated with workerd@1.20260515.1 2026-08-25 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	ADMIN_PASSWORD: string;
	ADMIN_SESSION_SECRET: string;
	COMPANY_PROFILE_WORKFLOW: Workflow /* CompanyProfileWorkflow */;
}
